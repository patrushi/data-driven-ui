    ...
    _createClass(OData, [{
        ...
        value: function getLongSelect(props, inputValue, callback) {
            ...
            if (Array.isArray(inputValue)) {
                ...
                filter = props.componentMeta.dataSource.sourceFunc ? props.componentMeta.dataSource.sourceFunc(inputValue) : _defineProperty({}, 'tolower(' + props.componentMeta.dataSource.value + ')', { contains: inputValue == null ? null : inputValue.toLowerCase() });
            ...
            var orderBy = props.componentMeta.dataSource.order || props.componentMeta.dataSource.value;
            var query = (0, _odataQuery2.default)({ filter: filter, top: top, format: format, orderBy: orderBy });
...
var _initialiseProps = function _initialiseProps() {
    ...
    this.getFilterForQueryUrl = function (meta, data, props) {
        var filter = _this2.getFilter(meta, data, props);
        var query = (0, _odataQuery2.default)({ filter: filter });
        return query;
    };
};
