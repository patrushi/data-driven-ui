...
var LongSelect = function (_PureComponent) {
    ...
    function LongSelect(props) {
        ...
        _this2.setValue = function (value) {
            if (equal(_this2.value, value)) return;
            _this2.value = value;
        ...
        _this2.setValueFromProps = function (value) {
            if (value === null || value === undefined || Array.isArray(value) && value.length === 0) {
                ...
                } else if (_this2.props.defaultOptions) _this.setValue(_this2.props.defaultOptions.filter(function (o) {
        ...
        _this2.componentDidMount = function () {
            ...
            var _this = _this2;
            if (_this2.props.componentMeta.preInit) {
                _this2.dataSource.getLongSelect(_this2.props, '', function (data) {
                    _this.setState({ defaultOptions: data });
                });
            } else if (_this2.props.defaultOptions) {
                _this.setState({ defaultOptions: _this2.props.defaultOptions });
            };
        };
        ...
        if (_this2.props.withoutDatasource !== true && _this2.props.meta.dataSource) {
                ...
                components.Option = function (props) {
                    return _react2.default.createElement(
                        ...
                        _react2.default.createElement(
                            ...
                            null,
                            props.children,
                            props.data && props.data.extraData ? _react2.default.createElement(
                                'div',
                                { style: { fontSize: 10 } },
