...
var ErrorPanel = function (_PureComponent) {
    ...
    _createClass(ErrorPanel, [{
        ...
        value: function render() {
            ...
            return _react2.default.createElement(_core.Dialog, { open: this.state.open, onClose: function onClose() {
                    return _this2.setState({ open: false });
                }, 'aria-labelledby': 'form-dialog-title' }, _react2.default.createElement(_core.DialogTitle, { id: 'form-dialog-title' }, this.props.title), _react2.default.createElement(_core.DialogContent, null, this.state.error ? this.state.error.toString() : null), _react2.default.createElement(_core.DialogActions, null, _react2.default.createElement(_core.Button, { onClick: function onClick() {
                    return _this2.setState({ open: false });
                } }, 'OK ...')));
        }
    }]);
