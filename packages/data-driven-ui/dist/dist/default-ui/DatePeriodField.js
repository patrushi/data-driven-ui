...
var DatePeriodField = function (_PureComponent) {
    ...
    _createClass(DatePeriodField, [{
        ...
        value: function render() {
            ...
            if (!value) value = {};
            return _react2.default.createElement(_react2.default.Fragment, null, _react2.default.createElement(_DateField2.default, _extends({}, rest, {
                label: label,
                value: value.from,
                placeholder: placeholder,
                onChange: function onChange(v) {
                    return _onChange(v === undefined && value.till === undefined ? undefined : { from: v, till: value.till });
                } })), _react2.default.createElement(_icons.Remove, { style: label ? { marginTop: '16px' } : undefined }), _react2.default.createElement(_DateField2.default, _extends({}, rest, {
