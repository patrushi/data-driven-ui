...
var ShortSelect = function (_PureComponent) {
    ...
    function ShortSelect() {
        ...
        return _possibleConstructorReturn(this, (ShortSelect.__proto__ || Object.getPrototypeOf(ShortSelect)).apply(this, arguments));
    }
    ...
    _createClass(ShortSelect, [{
        ...
        value: function render() {
            ...
            }), _react2.default.createElement(_MenuItem2.default, { key: defaultValue, value: defaultValue }), componentMeta.options.map(function (option) {
                return _react2.default.createElement(_MenuItem2.default, { key: option.key, value: option.key }, option.value || option.key);
            }));
        }
    }]);
