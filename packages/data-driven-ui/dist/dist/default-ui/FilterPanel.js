    ...
    _createClass(FilterPanel, [{
        ...
        value: function render() {
            ...
            if (!filtersLayout || !filtersLayout.type || filtersLayout.type === 'default') {
                ...
                return _react2.default.createElement(_react2.default.Fragment, null, filterLines.map(function (filters, rowIdx) {
                    return _react2.default.createElement(_Grid2.default, { container: true, key: rowIdx, spacing: 8 }, filters.map(function (filter, idx) {
                        return _react2.default.createElement(_Grid2.default, { item: true, xs: true, key: idx, style: { display: 'flex', alignItems: 'flex-begin' } }, _this2.getField(filter));
