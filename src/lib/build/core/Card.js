...
var _FieldComponentWrapper = require('../default-ui/FieldComponentWrapper');

var _FieldComponentWrapper2 = _interopRequireDefault(_FieldComponentWrapper);
...
var Card = function (_PureComponent) {
    ...
    function Card(props) {
        ...
        _this2.getFieldKey = function (meta, idx) {
            return meta.name ? meta.name : String(idx);
        };

        _this2.getComponent = function (meta) {
            return _FieldComponentWrapper2.default;
        };
